...
<div class="overlay"></div>
          ...
          <div class="col-12 my-auto">
            <div class="masthead-content text-white py-5 py-md-0">
              <h1 class="mb-3"><strong class="logo">BlockChain Logistica y Transporte</strong></h1>
                <img src="img/img1.jpg" class="img-rounded" alt="imagen1">
            </div>
    ...
    <div class="formulario">
           ...
           <p>Por favor, Ingresa todos los datos requeridos para su Registro.</p>
            ...
            <form id="Login" name="form" action="RegistroServlet" method="post" onsubmit="return validate()">
        
                <div class="form-group">
                  <input type="text" name="nombre" class="form-control input" placeholder="Nombres" required>
                </div>
                <div class="form-group">
                  <input type="text" name="apellido" class="form-control input" placeholder="Apellidos" required>
                </div>
                <div class="form-group">
                  <input type="email" name="email" class="form-control input" placeholder="Correo" required>
                </div>
                <div class="form-group">
                  <input type="number" name="ruc" class="form-control input" placeholder="DNI" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="hidden" name="tipo" value="cliente" class="form-control input" placeholder="Repite Contraseña" required>
                </div>            
                <div class="forgot">
                    <br>
                    ...
                    <br>
        <br>
                <input type="submit" value="REGISTRAR" class="btn btn-primary espacio a"/>
