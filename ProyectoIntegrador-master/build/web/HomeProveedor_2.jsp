...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <title>BlockChain y Transporte</title>
        ...
        <link href="css/estilo6.css" rel="stylesheet">
...
<body>
    <header>
        <div class="usuario">
            <div class="imagen">
                <img src="img/proveedor.jpg" class="img-responsive" alt="Responsive image"/>
            </div>
            
                <p class="texto">Bienvenido Empresa: <br><%=request.getAttribute("userName") %><p>
        ...
        <ul id="respMenu" class="ace-responsive-menu" data-menu-style="vertical">
            <li>
                <a href="HomeProveedor.jsp" >
                    <i class="glyphicon glyphicon-home" aria-hidden="true"></i>
                    <span class="title">Pagina Pricipal</span>
                </a>
            </li>
            <li>
                <a href="HomeProveedor_1.jsp">
            ...
            <li>
                <a href="#" class="active">
                    ...
                    <span class="title">Publicar Productos</span>
                </a>
            </li>
            <li>
                <a href="HomeProveedor_3.jsp">
        ...
        <div class="cuerpo">
            ...
            <div class="titulo">            
                <div class="centro"><h1>PUBLICAR PRODUCTOS</h1></div>
            </div> 
